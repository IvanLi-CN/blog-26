...
| cbwu4 | Next runtime reduction after admin SPA migration | ready | `cbwu4-next-runtime-reduction/SPEC.md` | 2026-04-17 | Follow up from 8amg2 by freezing the remaining legacy Next ownership, admin preview contract, memos `/api/trpc` residue, and the migration order for shrinking the internal Next runtime. |
