...
|---|---|---|---|---|---|
| n8ure | Nature frontend redesign without DaisyUI | in-progress | `n8ure-nature-front-ui/SPEC.md` | 2026-04-05 | Replace public DaisyUI styling with a dedicated Nature design system and stable visual evidence flow. |
...
| phgpd | Astro public frontend migration + single-image transition | in-progress | `phgpd-astro-front-phase1/SPEC.md` | 2026-04-08 | Move the public frontend to Astro, introduce compatibility HTTP APIs, and keep single-image deployment with a gateway in front of legacy Next. |
