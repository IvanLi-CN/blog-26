...
| m4c9u | Local memo root keeps `Memos` case | done | `m4c9u-local-memos-root-case/SPEC.md` | 2026-03-10 | Keep local memo writes aligned with the synced `Memos` tree, keep active env parsing strict, keep webdav-only memo UI tolerant of inactive local overrides, and block dot-segment memo roots. |
