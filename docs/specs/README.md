...
|---|---|---|---|---|---|
| n8ure | Nature frontend redesign without DaisyUI | in-progress | `n8ure-nature-front-ui/SPEC.md` | 2026-04-10 | Replace public DaisyUI styling with a dedicated Nature design system and stable visual evidence flow. |
