...
| 8amg2 | Admin shadcn SPA + `/admin/*` ownership migration | 部分完成（0/5） | `8amg2-admin-shadcn-spa-phase2/SPEC.md` | 2026-04-09 | Deliver the new admin SPA, add `/api/admin/*` compatibility resources, preserve admin auth semantics, and stop the fast-track at merge-ready. |
