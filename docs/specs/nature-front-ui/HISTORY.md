...
- 2026-09-26: Homepage featured-project cards gained official per-project logos, decorative responsive watermarks, and width-adaptive links, including an icon-only browse-all target on narrow screens, while leaving LoadLynx unbranded until its independent official asset is available.
