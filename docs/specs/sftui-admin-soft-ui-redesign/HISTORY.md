...
- 2026-06-18: Split admin file tabs into managed Markdown versus plain-text modes, added stable `contentKind`/`size` metadata to files APIs, blocked unsupported and oversized text opens with friendly Chinese errors, and stopped plain-text saves from triggering content sync.
