...
images: ['https://s3.ivanli.cc/ivan-public/uPic/2023/qldEtP.png']
---
...
下载完成后解压出来，把压缩文件里的 `rime` 目录复制到 `/home/example/.config/ibus/rime`：
...
![rime](https://s3.ivanli.cc/ivan-public/uPic/2023/E4SWeR.png)
