    ...
    <div className="dropdown dropdown-end dropdown-top md:dropdown-bottom dropdown-hover">
      ...
      >
        ...
        <Icon 
          ...
          className={`${iconClass} swap-off`} 
        />
        <Icon 
          name="line-md:moon" 
          className={`${iconClass} swap-on`} 
        />
      </label>

      <div
        tabIndex={0}
        className="dropdown-content z-[1] py-2 shadow-2xl bg-base-300 rounded-box w-52"
      >
          ...
          {UI.theme.mainThemes.map((theme: string) => (
            <li key={theme}>
              ...
              >
                ...
                {currentTheme === theme && (
                  <Icon name="tabler:check" className="w-4 h-4" />
                )}
              </a>
            </li>
          ))}
          ...
          {UI.theme.allThemes.map((theme: string) => (
            <li key={theme} data-theme={theme}>
              ...
              >
                ...
                {currentTheme === theme && (
                  <Icon name="tabler:check" className="w-4 h-4 ml-2" />
                )}
              </a>
            </li>
          ))}
