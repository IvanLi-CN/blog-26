                      ...
                      // 展开按钮
                      {
                        ...
                        properties: {
                          className: [
                            ...
                            "hover:text-[color:var(--nature-text)]",
                            "hover:bg-[rgba(var(--nature-highlight-rgb),0.38)]",
                            "transition-colors",
                            "duration-200",
                            "flex",
                            "items-center",
                            ...
                            "gap-1",
                            "border-t",
                            "border-[rgba(var(--nature-border-rgb),0.68)]",
                            "bg-[rgba(var(--nature-highlight-rgb),0.26)]",
                          ],
                          "data-action": "expand",
                          type: "button",
                        },
