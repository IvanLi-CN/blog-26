          ...
          >
            <div className="flex items-center gap-1">
              ...
              <svg className="w-4 h-4" viewBox="0 0 64 64" fill="currentColor">
                ...
                <path d="M25.5 26.5c-1.5-1.5-3.5-2.5-5.5-2.5-4.5 0-8 3.5-8 8s3.5 8 8 8c2 0 4-1 5.5-2.5M42.5 26.5c-1.5-1.5-3.5-2.5-5.5-2.5-4.5 0-8 3.5-8 8s3.5 8 8 8c2 0 4-1 5.5-2.5" stroke="currentColor" strokeWidth="3" fill="none"/>
              </svg>
